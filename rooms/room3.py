...
room3_description = '''
        . . .  3rd room ... 
        You walk in and are hit with the smell of various cleaning chemicals.
        This must be the janitor's closet. 
        You can feel your head start to hurt.
        You should probably get out of this room quickly. 
        While the lights flicker on you see a red door to the north. 
        Why is it red?
    ...
    while not done_with_room:
        ...
        if the_command == 'go':
            ...
            if go_where=='west':
                ...
                print('Walking up to the door you see that the door says exit. \n You have finally made it. \n Type go EXIT to escape.')
            elif go_where=='exit':
                next_room = 0
                done_with_room = True
            else:
            ...
            if use_what in player_inventory:
                if use_what == 'key':
                    direction = utils.prompt_question('Which door would you like to use the key on?',['west', 'north'])
                    if direction.lower() =='west':
                        ...
                        if door_locked:
                            if object[0] == 'wood':
                                ...
                                print('The EXIT door is now unlocked. Type go EXIT to escape.')
                            else:
